...
import { getAllProfiles } from "@/lib/airtable" // Import directly from airtable, bypassing the data.ts middleman
...
export default async function LocationsListPage() {
  ...
  // 2. Extract areas strictly from the 'based_in' field in your Airtable
  const uniqueAreas = new Set<string>()
  allProfiles.forEach(profile => {
    // profile.location maps to the 'based_in' field in your Airtable screenshot
